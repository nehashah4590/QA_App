...
const facts: string[] = [
    "  The diversity of trekking trails in Nepal ranges from the lowest point at 59 m above sea-level in the Tarai region to the highest point at Everest, 8,848 m above sea-level, only 200 kilometers apart. ",
    ...
    " Nepal is the only country in the world having non-rectangular flag. The Nepali flag is combination of two single traingles, symbolizing Himalays i.e. the greatest treasure that Nepal have. ",
    ...
    " The glacial lake situated at the highest altitude in the world is also situated in Nepal i.e. Tillicho lake located in Manang district, Nepal. ",
